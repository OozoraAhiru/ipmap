...
**Last updated:** 2026-04-02 05:41 UTC
...
| `Russian_v4.txt` `Russian_v6.txt` | RU, BY, KZ, AM, KG, TJ, MD | 12838 | 2643 | Russian sphere of influence (CSTO + Belarus) |
...
| `HackerTier2_v4.txt` `HackerTier2_v6.txt` | IN, ID, VN, PK, BD | 19931 | 8372 | Significant cybercrime sources |
| `HackerTier3_v4.txt` `HackerTier3_v6.txt` | TR, MA, DZ, MX | 3454 | 1261 | Moderate cybercrime sources |
